...
- 最后将配置项保存到 stm32mp1_atk_defconfig 里面 (*./arch/arm/config/stm32mp1_atk_defconfig*)
...
[报错libfakeroot.c:99:40: error: ‘\_STAT\_VER 解决](https://blog.csdn.net/weixin_41489977/article/details/119962326)


打开 c-stack.c 将下面第3行注释
...
```
setenv bootargs console=ttySTM0,115200 root=/dev/nfs nfsroot=192.168.10.150:/home/xemao/linux/nfs/rootfs,proto=tcp rw ip=192.168.10.50:192.168.10.150:192.168.10.1:255.255.255.0::eth0:off''
```
